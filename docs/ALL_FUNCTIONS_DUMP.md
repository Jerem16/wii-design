...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 10-154
// KIND: ArrowFunction
() => {
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 13-119
// KIND: ArrowFunction
() => {
        const runChecks = () => {
            const nextErrors: string[] = [];
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 14-115
// KIND: ArrowFunction
() => {
            const nextErrors: string[] = [];
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 17-19
// KIND: ArrowFunction
(message: string) => {
                nextErrors.push(message);
            }
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 21-29
// KIND: ArrowFunction
(message: string, elements?: Element[]) => {
                if (elements && elements.length > 0) {
                    // eslint-disable-next-line no-console
                    console.error(message, elements);
                } else {
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 31-38
// KIND: ArrowFunction
(id) => {
                const elements = Array.from(document.querySelectorAll(`[id="${id}"]`));
                if (elements.length > 0) {
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 50-85
// KIND: ArrowFunction
(logoNode, index) => {
                const logoId = logoNode.dataset.logoId || `logo-${index + 1}`;
                const gradient = logoNode.querySelector("linearGradient[id$='-A']");
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 67-84
// KIND: ArrowFunction
(target) => {
                    ["fill", "filter", "stroke"].forEach((attr) => {
                        const value = target.getAttribute(attr);
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 68-83
// KIND: ArrowFunction
(attr) => {
                        const value = target.getAttribute(attr);
                        if (!value || !value.includes("url(#")) {
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 94-94
// KIND: ArrowFunction
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 95-95
// KIND: ArrowFunction
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 100-105
// KIND: ArrowFunction
(id) => {
                if (seen.has(id)) {
                    duplicates.add(id);
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 118-118
// KIND: ArrowFunction
...
```ts
// SOURCE: app/debug/logo-test/LogoDebugChecks.tsx | Lines: 145-149
// KIND: ArrowFunction
(error) => (
                        <li key={error} style={{ marginBottom: "4px" }}>
                            {error}
...
```ts
// SOURCE: app/debug/logo-test/page.tsx | Lines: 3-44
// KIND: ArrowFunction
() => {
    return (
        <div
...
```ts
// SOURCE: app/debug/routes/page.tsx | Lines: 84-92
// KIND: FunctionDeclaration
...
```ts
// SOURCE: app/debug/routes/page.tsx | Lines: 94-125
// KIND: FunctionDeclaration
function DebugRoutesPage() {
  return (
    <main>
      <h1>Debug routes</h1>
...
```ts
// SOURCE: app/debug/routes/page.tsx | Lines: 102-108
// KIND: ArrowFunction
(route) => (
          <li key={route.url}>
            {route.href ? <Link href={route.href}>{route.url}</Link> : route.url}
...
```ts
// SOURCE: app/debug/routes/page.tsx | Lines: 116-120
// KIND: ArrowFunction
(apiRoute) => (
            <li key={apiRoute.url}>
              {apiRoute.url} — {apiRoute.file}
