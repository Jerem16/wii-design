...
const SvgDefBG3 = () => (
    ...
    >
        ...
        <path
            id="RX"
            fill="url(#AX)"
            d="M58,0H6C2.7,0,0,2.7,0,6v52c0,3.3,2.7,6,6,6h52c3.3,0,6-2.7,6-6V6C64,2.7,61.3,0,58,0z"
        />
    </svg>
);

export default dynamic(() => Promise.resolve(React.memo(SvgDefBG3)));
